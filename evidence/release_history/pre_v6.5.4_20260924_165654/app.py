...
if st.session_state.kb_outdated:
    ...
    if not web_kb_update_allowed:
        ...
        if st.button(
            ...
            # Use an isolated worker launched with the exact Python interpreter
            # serving Streamlit. This removes CWD/venv drift across PCs and keeps
            # update diagnostics separate from the live chat process.
            with st.spinner(
