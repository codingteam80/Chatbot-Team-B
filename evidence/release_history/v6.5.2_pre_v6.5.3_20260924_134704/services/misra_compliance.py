...
class MisraComplianceMode:
    ...
    def deterministic_yes_no_answer(
        ...
        # proposition.  Let one grounded generation step reason over the exact
        # Rule statement instead of reintroducing phrase-specific Yes/No logic.
        if any(
    ...
    def deterministic_scope_guard_answer(
        ...
        if any(
            ...
            return "", {"reason": "corpus-semantic Rule resolution defers proposition reasoning to grounded generation"}
