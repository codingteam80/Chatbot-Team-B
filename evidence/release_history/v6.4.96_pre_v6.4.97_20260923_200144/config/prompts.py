...
Good alternatives: requirements for labels referenced by goto statements |
constraints on goto target label scope

Example B
Input: Why should persistent side effects be avoided in the right operand of && or ||?
Good alternatives: rationale for persistent side effects in the right operand of && or || |
purpose of avoiding persistent side effects in logical &&/|| right operands

Example C
Input: Pwede ba recursion sa MISRA?
Good alternatives: whether recursion is permitted by MISRA |
MISRA permission requirements for recursion
