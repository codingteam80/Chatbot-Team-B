...
def main():
    ...
    # --------------------------------------------------------------
    checks.append(check(
        "Validator targets DocuBot CompanyRetriever",
        hasattr(CompanyRetriever, "_retrieve_structured_rule_major_family"),
        "CompanyRetriever._retrieve_structured_rule_major_family",
    ))

    fake_retriever = CompanyRetriever.__new__(CompanyRetriever)
    ...
    report = {
        ...
        "verification_hotfix": "validator_class_reference_only",
        "runtime_behavior_changed_by_v6_4_91_1": False,
        "manual_retest": (
