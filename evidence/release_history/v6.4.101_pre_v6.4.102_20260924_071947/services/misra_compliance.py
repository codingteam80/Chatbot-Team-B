...
class MisraComplianceMode:
    ...
    def yes_no_intent(cls, question: str) -> str:
        ...
        if (
            ...
            and re.search(r"\b(?:allow|allows|allowed|permit|permits|permitted|acceptable|valid|okay|ok|use|used|using|have|leave|keep|place|placed|placing|omit|omits|omitted|omitting|exclude|excluded|skip|skipped|remove|removed)\b", permission_clean)
    ...
    def _unused_function_parameter_concept(cls, question: str) -> bool:
        ...
        def usage_term(token: str) -> bool:
            return (
                token in {
                    "use", "used", "using", "read", "reads", "reading",
