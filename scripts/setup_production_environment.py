...
def _verify_imports() -> dict[str, str]:
    modules = {
        ...
        # KB update / document ingestion dependencies.  Verifying these during
        # setup prevents the web Update Knowledge Base button from discovering
        # a missing parser package only after a user clicks it.
