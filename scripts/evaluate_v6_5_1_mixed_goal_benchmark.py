...
def normalize(text: Any) -> str:
    # Evidence logging/UI rendering may remove Markdown backticks or normalize
    # punctuation around code-like tokens. Benchmark identity should therefore
    # compare semantic text tokens rather than raw Markdown punctuation.
