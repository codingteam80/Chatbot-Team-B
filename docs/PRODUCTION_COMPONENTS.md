# Canonical Production Components — v6.4.83 Deployment Bootstrap Candidate
...
Historical Chroma, multilingual-E5, Llama3 model profiles, v3 Qdrant rollback storage, trial/AB launchers, and promotion harnesses are not active production components.
